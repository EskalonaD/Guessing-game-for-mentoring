...
/* harmony default export */ __webpack_exports__["default"] = ("<app-wrapper></app-wrapper>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button>{{ title }}</button>\n");
...
/* harmony import */ var _scroll_directive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./scroll.directive */ "./src/app/scroll.directive.ts");
/* harmony import */ var _scroll_button_scroll_button_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./scroll-button/scroll-button.component */ "./src/app/scroll-button/scroll-button.component.ts");
/* harmony import */ var _game_anchor_directive__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./game-anchor.directive */ "./src/app/game-anchor.directive.ts");
/* harmony import */ var _wrapper_wrapper_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./wrapper/wrapper.component */ "./src/app/wrapper/wrapper.component.ts");
...
/* harmony import */ var _input_input_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./input/input.component */ "./src/app/input/input.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _scroll_directive__WEBPACK_IMPORTED_MODULE_9__["ScrollDirective"],
            _scroll_button_scroll_button_component__WEBPACK_IMPORTED_MODULE_10__["ScrollButtonComponent"],
            _game_anchor_directive__WEBPACK_IMPORTED_MODULE_11__["GameAnchorDirective"],
            _wrapper_wrapper_component__WEBPACK_IMPORTED_MODULE_12__["WrapperComponent"],
...
], FooterComponent.prototype, "startAnotherGame", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], FooterComponent.prototype, "endGame", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GameAnchorDirective", function() { return GameAnchorDirective; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let GameAnchorDirective = class GameAnchorDirective {
    constructor(viewRef) {
        this.viewRef = viewRef;
    }
};
GameAnchorDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"] }
];
GameAnchorDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _guesser_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./guesser.service */ "./src/app/guesser.service.ts");
/* harmony import */ var _puzzler_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./puzzler.service */ "./src/app/puzzler.service.ts");
...
let GameService = class GameService {
    constructor(guesser, puzzler, state) {
        this.guesser = guesser;
        this.puzzler = puzzler;
        this.state = state;
        this.chatListener$ = this.state.chat$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])((data) => {
            if (data.stop === true) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _project_state_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @project/state.service */ "./src/app/state.service.ts");
/* harmony import */ var _project_game_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @project/game.service */ "./src/app/game.service.ts");
...
let GameComponent = class GameComponent {
    ...
    ngOnInit() {
        ...
        this.messages$ = this.game.chatListener$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscriber$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["scan"])((acc, val) => {
            if (val.stop) {
        ...
        this.state.messageShouldScroll$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscriber$)).subscribe(boolean => this.shouldScroll = boolean);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GuesserService", function() { return GuesserService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _project_state_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @project/state.service */ "./src/app/state.service.ts");
...
let GuesserService = class GuesserService {
    constructor(state) {
        this.state = state;
...
GuesserService.ctorParameters = () => [
    { type: _project_state_service__WEBPACK_IMPORTED_MODULE_2__["StateService"] }
];
GuesserService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], GuesserService);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], HeaderComponent.prototype, "showStartGameButton", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], HeaderComponent.prototype, "start", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CUSTOM_INPUT_VALUE_ACCESSOR", function() { return CUSTOM_INPUT_VALUE_ACCESSOR; });
...
const CUSTOM_INPUT_VALUE_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => InputComponent),
    multi: true,
};
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], InputComponent.prototype, "blurred", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('input', { static: true })
], InputComponent.prototype, "input", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('animatedPlaceholder', { static: true })
], InputComponent.prototype, "animatedPlaceholder", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('fieldset', { static: true })
], InputComponent.prototype, "fieldset", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('span', { static: true })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PuzzlerService", function() { return PuzzlerService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _project_state_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @project/state.service */ "./src/app/state.service.ts");
...
PuzzlerService.ctorParameters = () => [
    { type: _project_state_service__WEBPACK_IMPORTED_MODULE_2__["StateService"] }
];
PuzzlerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], PuzzlerService);
...
let ScrollButtonComponent = class ScrollButtonComponent {
    constructor() {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ScrollButtonComponent.prototype, "direction", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ScrollButtonComponent.prototype, "scrollTo", void 0);
ScrollButtonComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-scroll-button',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./scroll-button.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/scroll-button/scroll-button.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./scroll-button.component.scss */ "./src/app/scroll-button/scroll-button.component.scss")).default]
    })
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('appScroll')
], ScrollDirective.prototype, "shouldApply", void 0);
...
/* harmony import */ var _project_game_anchor_directive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @project/game-anchor.directive */ "./src/app/game-anchor.directive.ts");
/* harmony import */ var _project_game_game_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @project/game/game.component */ "./src/app/game/game.component.ts");
/* harmony import */ var _project_footer_footer_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @project/footer/footer.component */ "./src/app/footer/footer.component.ts");
...
let WrapperComponent = class WrapperComponent {
    constructor(state, renderer, resolver) {
        this.state = state;
        this.renderer = renderer;
    ...
    ngOnInit() {
        ...
        this.state.isEnded$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.unsubscriber$)).subscribe(shouldShow => {
        ...
        this.state.messageShouldScroll$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.unsubscriber$)).subscribe(boolean => {
            this.shouldUpdateMessageShouldScroll = boolean;
            this.showScrollBottomButton = !boolean;
        });
        this.state.chat$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.unsubscriber$)).subscribe(_ => this.onScroll());
    }
    ngAfterViewInit() {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('contentContainer', { static: false })
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_project_game_anchor_directive__WEBPACK_IMPORTED_MODULE_5__["GameAnchorDirective"], { static: true })
], WrapperComponent.prototype, "gameContainer", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_project_footer_footer_component__WEBPACK_IMPORTED_MODULE_7__["FooterComponent"], { static: false })
], WrapperComponent.prototype, "footer", void 0);
WrapperComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-wrapper',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./wrapper.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/wrapper/wrapper.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./wrapper.component.scss */ "./src/app/wrapper/wrapper.component.scss")).default]
    })
], WrapperComponent);
...
module.exports = __webpack_require__(/*! D:\Projects\Game\src\main.ts */"./src/main.ts");
